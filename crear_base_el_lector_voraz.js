...
async function crearBaseDeDatos() {
  try {
    ...
    const proveedores = [
      { nombre: 'Editorial Sudamericana', mail: 'sudamericana@editorial.com', tipo_proveedor: 'libreria', telefono: '+5491111111111', sitio_web: 'https://sudamericana.com' },
      { nombre: 'Planeta Libros', mail: 'contacto@planeta.com', tipo_proveedor: 'libreria', telefono: '+5492222222222', sitio_web: 'https://planeta.com' },
      { nombre: 'Ediciones Santillana', mail: 'info@santillana.com', tipo_proveedor: 'libreria', telefono: '+5493333333333', sitio_web: 'https://santillana.com' },
      { nombre: 'Penguin Random House', mail: 'ventas@penguinrandomhouse.com', tipo_proveedor: 'libreria', telefono: '+5494444444444', sitio_web: 'https://penguinrandomhouse.com' },
      { nombre: 'Siglo XXI Editores', mail: 'info@sigloxxieditores.com', tipo_proveedor: 'libreria', telefono: '+5495555555555', sitio_web: 'https://sigloxxieditores.com' },
      // Cafetería
      { nombre: 'Café Martínez', mail: 'contacto@cafemartinez.com', tipo_proveedor: 'cafeteria', telefono: '+5496666666666', sitio_web: 'https://cafemartinez.com' },
      { nombre: 'Bonafide', mail: 'info@bonafide.com', tipo_proveedor: 'cafeteria', telefono: '+5497777777777', sitio_web: 'https://bonafide.com' },
      // Utilería
      { nombre: 'Utilería Express', mail: 'ventas@utileriaexpress.com', tipo_proveedor: 'utileria', telefono: '+5498888888888', sitio_web: 'https://utileriaexpress.com' },
      { nombre: 'Papelería Central', mail: 'info@papeleriacentral.com', tipo_proveedor: 'utileria', telefono: '+5499999999999', sitio_web: 'https://papeleriacentral.com' }
    ];
    ...
    console.log('Eliminando proveedores, libros, ventas y usuarios...');
    ...
    console.log('Insertando libro ficticio...');
